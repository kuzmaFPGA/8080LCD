...
HD_PWD='D:/Xilinx/Projects/8080LCD/8080LCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mrb3973_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mrb3973_test.tcl
